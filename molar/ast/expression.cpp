...
namespace molar::ast {
    std::string ast_kind_to_string(const AstKind kind) {
        switch (kind) {
            ...
            case AstKind::TernaryExpression: return "TernaryExpression";
            case AstKind::ConditionalExpression: return "ConditionalExpression";
            case AstKind::AssignmentExpression: return "AssignmentExpression";
            case AstKind::ResourceExpression: return "ResourceExpression";
            case AstKind::ArrayAccessExpression: return "ArrayAccessExpression";
            case AstKind::ArrowAccessExpression: return "ArrowAccessExpression";
            case AstKind::CallExpression: return "CallExpression";
            case AstKind::LoopExpression: return "LoopExpression";
            case AstKind::ForEachExpression: return "ForEachExpression";
